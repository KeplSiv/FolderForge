...
enum BuiltInPresets {
    ...
    static let all: [FolderStyle] = [
        ...
        make("Receipts", hex: "#FF9F0A", symbol: "receipt.fill"),
        make("Payroll", hex: "#32D74B", symbol: "banknote.fill"),
        make("Tax", hex: "#5E5CE6", symbol: "building.columns.fill"),
        make("Legal", hex: "#6E85A8", symbol: "building.columns.fill"),
