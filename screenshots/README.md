...
| `icns-import.png`  | External ICNS applied as the whole folder icon.             | Cropped from `--icon`.             |
...
D=/tmp/Showcase
ICON=/path/to/downloaded-icon.icns
...
"$BIN" --ui-snapshot icns-import-source.png --width 1080 --height 700 --folders "$FOLDERS" --icon "$ICON"
...
magick icns-import-source.png -crop 1680x1400+480+0 +repage -resize 1200x1000\> icns-import.png
